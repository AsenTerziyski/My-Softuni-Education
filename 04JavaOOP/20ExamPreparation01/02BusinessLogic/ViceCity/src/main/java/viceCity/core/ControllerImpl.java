...
public class ControllerImpl implements Controller {
    ...
    public String addGunToPlayer(String name) {
        ...
        String familyNameOfMainPlayer = mainPlayer.getName().split(" ")[1];
        if (name.equals(familyNameOfMainPlayer)) {
        ...
        return String.format(GUN_ADDED_TO_MAIN_PLAYER, gunName, playerName);
    }
    ...
    public String fight() {
        ...
        if (mainPlayer.getLifePoints() == 100 && players.values().stream().allMatch(player -> player.getLifePoints() == 50)) {
        ...
        out
                ...
                .append(System.lineSeparator()).append(String.format(CIVIL_PLAYERS_LEFT_MESSAGE, players.size()-deadPlayers.size()));
